...
const AuthenticatedApp: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // Simplificando a query removendo orderBy para evitar erro de "requires index"
    // Ordenaremos os dados no cliente (Javascript)
    const q = query(
    ...
    const unsubscribe = onSnapshot(q, (querySnapshot) => {
      ...
      // Ordenação feita aqui para evitar complexidade de índices no Firebase Console
